...
export default function Project({
  ...
  return (
    ...
    >
      ...
      <a
          className=" w-1/12  p-4 m-4 flex items-center justify-center gap-2 text-[1.5rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack bg-white/10 text-white/60"
          href={git}
          target="_blank"
        >
